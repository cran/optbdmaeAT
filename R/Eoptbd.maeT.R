#Subsection  2.4: Function  for search of E-optimal or near-optimal block designs
# SubSubsection 2.4.1 (Function for construction of E-optimal block designs using treatment exchange algorithm) 
Eoptbd.maeT<-function(trt.N,blk.N,theta,nrep,itr.cvrgval) {
  #House keeping
  ...
  return(Eopt_sum2)
}#End of SubSubsection 2.4.1 (Eoptbd.maeT function) construction of E-optimal block design using treatment exchange algorithm
